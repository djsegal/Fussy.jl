@testset "Magnet Zp Array Function Tests" begin
  ...
  actual_value = Tokamak.magnet_zp_array()

  expected_value = [2.74590000000000  -2.74590000000000 1.68822000000000  -1.68822000000000]
