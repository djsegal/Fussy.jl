@testset "Magnet Kp Function Tests" begin
  ...
  actual_value = Tokamak.magnet_kp()

  expected_value = [0.843210038971829,0.843210038971829,0.866317916677410,0.866317916677410]
