@testset "Coil Inductance Function Tests" begin

  @test isdefined(Tokamak, :Coil_Inductance) == true
  ...
  actual_value = Tokamak.Coil_Inductance()

  expected_value = 0.013730809201003
